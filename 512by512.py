...
class Paint():
    ...
    def run_program(self):
        ...
        args = argparse.Namespace(comment='',  config='church_2.yml', exp='./runs/', image_folder='images', ni=True, npy_name='lsun_church', sample=True, sample_step=1, seed=self.seed, t=self.t, verbose='info')
